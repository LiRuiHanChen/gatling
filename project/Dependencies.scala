...
object Dependencies {
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                            % "1.4.4")
    ...
    .exclude("org.scala-lang","scala-library_2.13")
  ...
  private val commons_math3                  = "org.apache.commons"                   % "commons-math3"                   % "3.4.1"
  private val oshi                           = "com.github.oshi"                      % "oshi-core"                       % "5.3.5"
