...
object ConfigKeys {
  ...
  object index {
    val ActiveUsers = "gatling.index.activeUsers"
    val ResponseTimePercentiles3 = "gatling.index.responseTimePercentiles3"
    val RequestKoPercentage = "gatling.index.requestKoPercentage"
    val ResponseTimePercentage = "gatling.index.responseTimePercentage"
  }
